# Maleghast_Unofficial System

![Foundry v10](https://img.shields.io/badge/foundry-v10-green)

This system is a maleghast_unofficial system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

Before installing this system, you should rename any files that have `maleghast_unofficial` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `maleghast_unofficial` and `Maleghast_Unofficial` and do the same for those, replacing them with appropriate names for your system.

### System Generator

This project is also available as generator that can be run with npm: https://www.npmjs.com/package/generator-foundry

### Vue 3 Maleghast_Unofficial
...
Head over to the [Vue3Maleghast_Unofficial System](https://gitlab.com/asacolips-projects/foundry-mods/vue3maleghast_unofficial) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/maleghast_unofficial.png)
